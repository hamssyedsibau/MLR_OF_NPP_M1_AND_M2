...
dp = NCDataset("/mnt/sda5-ext4/uci/Ekman_Geostrophic/version_0/global-analysis-forecast-bio-001-028-daily_1644812315258.nc");
...
ds = NCDataset("/mnt/sda5-ext4/uci/Ekman_Geostrophic/version_0/dataset-uv-rep-daily_1644812992863.nc");
...
nt = 365 # because data avalible day (replace this with nt to process at all avalible times in dataset)
